...
#define FONT_DATA_MAX 4096
static int ASCII_font_init(char *pcFontFile, unsigned int dwFontSize);
static int ASCII_get_font_bitmap(unsigned int dwCode, P_Font_Bit_Map ptFontBitMap);

static T_Font_Ops g_t_ASCII_font_ops = {
        .name               = "ascii",
        .Font_init          = ASCII_font_init,
        .Get_font_bitmap    = ASCII_get_font_bitmap,
};

static const unsigned char fontdata_8x16[FONT_DATA_MAX] = {
...
int ASCII_init(void){
    return Register_font_ops(&g_t_ASCII_font_ops);
}